  ...
  module ByPassword
    ...
    module ModelClassMethods
      ...
      def password_digest(password, salt)
        digest = ErpTechSvcs::Authentication::Constants::REST_AUTH_SITE_KEY
        ErpTechSvcs::Authentication::Constants::REST_AUTH_DIGEST_STRETCHES.times do
          digest = secure_digest(digest, salt, password, ErpTechSvcs::Authentication::Constants::REST_AUTH_SITE_KEY)
        end
        digest
      end      
    end # class methods
