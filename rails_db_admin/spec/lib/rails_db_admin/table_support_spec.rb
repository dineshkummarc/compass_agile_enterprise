  ...
  describe "instance methods" do 
    ...
    describe "update_table_without_id" do
      ...
      it "should be able to send a correctly formed SQL statment to the ConnectionAdapter" do
        ...
        sql = "UPDATE preference_options_preference_types "\
              ...
              "'2011-10-11 00:54:56.137144' WHERE 1=1 AND "\
              "preference_type_id = '2' AND preference_option_id = '2' "\
              "AND created_at IS NULL AND updated_at = '2011-10-11 00:54:56.137144' "
    ...
    describe "insert_row" do
      ...
      it "should return an id" do
        ...
        sql = "insert into role_types (parent_id, lft, rgt, "\
              "description, comments, internal_identifier, "\
              "external_identifier, external_id_source, created_at, "\
              "updated_at) values ( null,'3','4','Partner-Test',null,"\
    ...
    describe "delete_fake_id_row" do
      ...
      it "should execute a valid sql statment to delete a row" do 
        ...
        sql = "DELETE FROM preference_options_preference_types "\
              "WHERE 1=1 AND preference_type_id = '1' "\
              "AND preference_option_id = '2' AND created_at = "\
              "'2011-10-11 00:54:56.137144' AND updated_at = "\
              "'2011-10-11 00:54:56.137144' "
