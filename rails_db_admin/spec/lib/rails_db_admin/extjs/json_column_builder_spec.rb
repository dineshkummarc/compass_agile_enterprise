  ...
  describe "build_grid_columns" do 
    ...
    it "should return an array of hashes to setup a ExtJS Grid column object" do
      ...
      expected_result =[{:header=>"id", :type=>"number", :dataIndex=>"id", :width=>150},
                        {:header=>"parent_id", :type=>"number", :dataIndex=>"parent_id", :width=>150, :editor=>{:xtype=>"textfield"}},
                        {:header=>"lft", :type=>"number", :dataIndex=>"lft", :width=>150, :editor=>{:xtype=>"textfield"}},
                        {:header=>"rgt", :type=>"number", :dataIndex=>"rgt", :width=>150, :editor=>{:xtype=>"textfield"}},
                        {:header=>"description", :type=>"string", :dataIndex=>"description", :width=>150, :editor=>{:xtype=>"textfield"}},
                        {:header=>"comments", :type=>"string", :dataIndex=>"comments", :width=>150, :editor=>{:xtype=>"textfield"}},
                        {:header=>"internal_identifier", :type=>"string", :dataIndex=>"internal_identifier", :width=>150, :editor=>{:xtype=>"textfield"}},
                        {:header=>"external_identifier", :type=>"string", :dataIndex=>"external_identifier", :width=>150, :editor=>{:xtype=>"textfield"}},
                        {:header=>"external_id_source", :type=>"string", :dataIndex=>"external_id_source", :width=>150, :editor=>{:xtype=>"textfield"}},
                        {:header=>"created_at", :type=>"date", :dataIndex=>"created_at", :width=>150},
                        {:header=>"updated_at", :type=>"date", :dataIndex=>"updated_at", :width=>150}]
