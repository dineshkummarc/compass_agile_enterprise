module ActsAsSolr #:nodoc:
  module ParserMethods
    ...
    def parse_query(query=nil, options={}, models=nil)
      valid_options = [:offset, :limit, :facets, :models, :results_format, :order, :scores, :operator, :include, :lazy, :wt, :qt]
      query_options = {}
      ...
      begin
        ...
        query_options[:wt] = options[:wt] if options[:wt]
        query_options[:qt] = options[:qt] if options[:qt]
