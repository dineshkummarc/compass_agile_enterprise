class IndividualObserver < ActiveRecord::Observer
  ...
  def after_save(individual)
    begin
      #PartySearchFact.update_search_fact(individual.business_party) #Commented out due to custom OlPartySearchFact
      #OlPartySearchFact.update_search_fact(individual.party)
