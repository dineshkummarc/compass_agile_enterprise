...
#      #PartySearchFact.update_search_fact(postal_address.contact.party) #Commented out due to custom OlPartySearchFact
#      OlPartySearchFact.update_search_fact(postal_address.contact.party)
#    rescue
#    end
#  end
#
