module ErpApp
	module HasUserPreferences
      ...
      base.extend(ClassMethods)
        ...
        extend ErpApp::HasUserPreferences::SingletonMethods
			  include ErpApp::HasUserPreferences::InstanceMethods
...
ActiveRecord::Base.send(:include, ErpApp::HasUserPreferences)
