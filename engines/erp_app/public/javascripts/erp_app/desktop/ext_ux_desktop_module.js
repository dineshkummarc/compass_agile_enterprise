...
Ext.define("Ext.ux.desktop.Desktop",{
    ...
    shortcutTpl:['<div style="width:300px"><tpl for=".">','<div class="ux-desktop-shortcut" id="{name}-shortcut">','<div class="ux-desktop-shortcut-icon {iconCls}">','<img src="',Ext.BLANK_IMAGE_URL,'" title="{name}">',"</div>",'<span class="ux-desktop-shortcut-text">{name}</span>',"</div>","</tpl></div>",'<div class="x-clear"></div>'],
    taskbarConfig:null,
    windowMenu:null,
...
/*
 *
 *   Ext.ux.desktop.Clock
 *
 */

Ext.define("Ext.ux.desktop.Clock",{
    extend:"Ext.panel.Panel",
    requires:["Ext.menu.Menu","Ext.toolbar.Toolbar"],
    ariaRole:"menu",
    cls:"x-menu ux-start-menu",
    ...
    initComponent:function(){
        ...
        var clock = Ext.create("Ext.panel.Panel",{
            ...
            height:175,
            width:175,
            html:'<canvas class="CoolClock:chunkySwiss"></canvas><br/><div style="text-align:center;width:100%;font-size:18px;"><span id="desktopClockTime"></span></div>'
        });
    ...
    updateTime:function(){
        ...
        if(el){
            var time=a.tpl.apply({time:Ext.Date.format(new Date(),a.timeFormat)});
