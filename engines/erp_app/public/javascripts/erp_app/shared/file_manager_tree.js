      ...
      'itemcontextmenu':function(view, record, item, index, e){
        ...
        if(!record.data['leaf']){
                ...
                var uploadWindow = new Compass.ErpApp.Shared.UploadWindow({
                  ...
                  listeners:{
                    'fileuploaded':function(){
                      store.load({node:record, params:self.extraPostData});
          ...
          menuItems.push({
            ...
            listeners:{
              'click':function(){
                window.open((self.initialConfig['controllerPath']  || './file_manager/base') + "/download_file/?path=" + record.data.id,'mywindow','width=400,height=200');
              }
            }
          });
        //}
