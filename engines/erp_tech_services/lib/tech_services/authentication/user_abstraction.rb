module TechServices::Authentication
  module UserAbstraction
    ...
    def self.included( recipient )
      ...
      recipient.class_eval do
        ...
        validates_numericality_of :invitation_limit,
          :less_than_or_equal_to => TechServices::Authentication::Constants::MAX_USER_INVITE_LIMIT,
    ...
    module ModelInstanceMethods
      ...
      def to_param
        ...
        self.activation_code_expires_at = nil
		    save
		  end
		  ...
		  def recently_created?
			...
			def add_invites(number)
				...
				if ((self.invitation_limit + number) > Constants::MAX_USER_INVITE_LIMIT)
					self.invitation_limit = Constants::MAX_USER_INVITE_LIMIT
				else
