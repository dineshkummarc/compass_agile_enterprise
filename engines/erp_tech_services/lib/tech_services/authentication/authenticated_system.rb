module TechServices::Authentication::AuthenticatedSystem
  ...
  protected
    ...
    def login_from_session
      ...
      #######################################################################
      #TODO: FIX THIS!!!                                                  ###
      #User needs to be renamed.  When it is being called in this method  ###
      #it is conflicting with some other User and is not loading it       ###
      #correctly.  This hack works for now but this needs to be addressed.###
      #######################################################################
      #######################################################################
      unless defined?(User)
        "User".constantize
