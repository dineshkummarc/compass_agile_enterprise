  ...
  module ByPassword
    ...
    def self.included(recipient)
      ...
      recipient.class_eval do
        ...
        validates_length_of       :password, :within => 6..40, :too_long => "too long", :too_short => "too short", :if => :password_required?
    ...
    module ModelClassMethods
      ...
      def password_digest(password, salt)
        digest = TechServices::Authentication::Constants::REST_AUTH_SITE_KEY
        TechServices::Authentication::Constants::REST_AUTH_DIGEST_STRETCHES.times do
          digest = secure_digest(digest, salt, password, TechServices::Authentication::Constants::REST_AUTH_SITE_KEY)
        end
        digest
      end      
    end # class methods
